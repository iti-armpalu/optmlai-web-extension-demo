...
import { Layers, Mail, Sparkles, CreditCard } from "lucide-react"
        ...
        <div className="space-y-4 py-4">
          <div className="rounded-lg border border-primary/20 bg-primary/5 p-3">
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm">
                <span className="font-semibold">3 free credits</span> to explore all features. No credit card required.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            >
              <svg className="mr-2 size-5 shrink-0" viewBox="0 0 24 24">
                <path
                  fill="currentColor"
          ...
          <div className="space-y-3">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-background px-2 text-muted-foreground">Need more?</span>
              </div>
            </div>
