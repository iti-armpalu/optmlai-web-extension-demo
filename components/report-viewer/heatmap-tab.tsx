                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 space-y-1">
                                ...
                                <p className="text-sm text-muted-foreground leading-relaxed">
                                    Viewers focus on the <strong className="text-foreground">headline and superhero imagery</strong> first
                                    (0-0.8s), then scan the <strong className="text-foreground">product benefits section</strong>{" "}
                                    (0.8-1.5s). Body text and CTA receive minimal attention in quick-glance contexts.
                                </p>
